...
public class StreamingPlatform {
    ...
    public void registerUser() {
        ...
        allUsers.add(user); // Tilføj brugeren til listen af alle brugere

        // Forbered dataen til at blive gemt i filen
        List<String> userData = new ArrayList<>();
        userData.add(user.getUserName() + "," + user.getPassword() + "," + user.getAge()); // Formatér som en CSV-linje

        io.saveUserData(userData, "data/userdata.txt");
        ui.displayMsg("Welcome " + userName+"!");  //Skal tilføjes users name til hilsen
    }
